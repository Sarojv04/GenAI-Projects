...
class Review(TypedDict):
    key_themes : Annotated[list[str], "write down main key themes discussed in the review"]
    summary : Annotated[str, "A brief summary of the review "]
    #sentiment : Annotated[str, "Return sentimemt of the review either negative positive or beutral"]
    sentiment : Annotated[Literal["Pos","Neg", "Nul"], "Return sentimemt of the review either negative positive or neutral"]
    pros : Annotated[Optional[list[str]],"write down all the pros inside the review"]
